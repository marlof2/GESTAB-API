...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = [
            ...
            ['name' => 'Ricardo', 'profile_id' => 3, 'phone' => '71991717220', 'cpf' => '03296244583', 'email' => 'ricardo@example.com', 'password' => Hash::make('123'), 'type_schedule' => 'HM'],
            ['name' => 'Patrícia', 'profile_id' => 3, 'phone' => '71991717221', 'cpf' => '85472136985', 'email' => 'patricia@example.com', 'password' => Hash::make('123'), 'type_schedule' => 'OC'],
