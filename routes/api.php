...
Route::prefix('typeofpeople')->group(function () {
...
Route::prefix('establishmentservices')->group(function () {
...
Route::prefix('profiles')->group(function () {
    ...
    Route::get('/', [App\Http\Controllers\ProfileController::class, 'index'])->middleware('abilities:profile_list');

    Route::post('/', [App\Http\Controllers\ProfileController::class, 'store'])->middleware('abilities:profile_insert');

    Route::get('/{id}', [App\Http\Controllers\ProfileController::class, 'show'])->middleware('abilities:profile_by_id');

    Route::put('/{id}', [App\Http\Controllers\ProfileController::class, 'update'])->middleware('abilities:profile_edit');

    Route::delete('/{id}', [App\Http\Controllers\ProfileController::class, 'destroy'])->middleware('abilities:profile_delete');
});
...
Route::prefix('establishmentprofessionals')->group(function () {
